...
var services = [
  {
    ...
    short:
      "Efficient layouts, considered materials, lighting and finishes shaped around your needs, style and budget.",
    description:
  ...
  },
  {
    ...
    short:
      "New construction, renovation and structural alterations delivered with quality and close coordination.",
    description:
  ...
  },
  {
    ...
    short:
      "Complete coordination of design, procurement, manpower and site execution through one accountable team.",
    description:
  ...
  },
  {
    ...
    short:
      "Kitchens, wardrobes, cabinetry, panelling, ceilings and furniture made for how you live and work.",
    description:
  ...
  },
  {
    ...
    short:
      "Essential building services integrated carefully into the design and construction process.",
    description:
  ...
  },
  {
    ...
    short:
      "Offices, boutiques, cafés, hotels and wellness spaces that balance identity with operational needs.",
    description:
...
var projects = [
  {
    ...
    description:
      "A contemporary tropical residence balancing openness with privacy, designed around the landscape.",
    imageKey: "residence",
  },
  {
    id: 2,
    ...
    description:
      "Refined Kerala heritage aesthetics meeting modern comfort in a boutique property.",
  ...
  },
  {
    ...
    description:
      "Complete turnkey renovation of a city-centre penthouse—design to handover in 14 weeks.",
    imageKey: "about",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    description:
      "Atmospheric dining space with architectural drama, warm textures and curated lighting.",
    imageKey: "hospitality",
  },
];
//#endregion
